...
Known Issues:
  - IQ2020 boards prior to 2014 will not work with this integration. See [Tested Hot Tubs](https://github.com/Ylianst/ESP-IQ2020/blob/main/documentation/tested.md) for details.
